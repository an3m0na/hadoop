...
import org.apache.hadoop.tools.posum.database.util.DataExporter;
...
public class TestDataImportExport {
    ...
    public void test() throws Exception {
        ...
        new DataExporter(dataBroker).exportTo(dataDumpPath);
        ...
        new DataImporter(dataDumpPath).importTo(dataBroker);
