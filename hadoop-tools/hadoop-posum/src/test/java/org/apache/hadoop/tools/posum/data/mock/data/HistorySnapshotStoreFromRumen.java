...
public class HistorySnapshotStoreFromRumen extends MockDataStoreImpl {// implements TraceSnapshotMockDS {
    ...
    private JobProfile snapshot(JobProfile original) {
        ...
        copy.setStartTime(original.getStartTime() > currentTime ? 0 : original.getStartTime());
        copy.setFinishTime(original.getFinishTime() > currentTime ? 0 : original.getFinishTime());
