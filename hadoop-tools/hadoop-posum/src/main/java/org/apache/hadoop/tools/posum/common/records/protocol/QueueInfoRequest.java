 ...
 */
public abstract class QueueInfoRequest {

    public static QueueInfoRequest newInstance(NodeAddedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        request.setNode(POSUMNode.newInstance(event.getAddedRMNode()));
        request.setContainerReports(event.getContainerReports());
        return request;
    }

    public static QueueInfoRequest newInstance(NodeRemovedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        request.setNode(POSUMNode.newInstance(event.getRemovedRMNode()));
        return request;
    }

    public static QueueInfoRequest newInstance(NodeResourceUpdateSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
    ...
    public static QueueInfoRequest newInstance(NodeUpdateSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        request.setNode(POSUMNode.newInstance(event.getRMNode()));
        return request;
    }

    public static QueueInfoRequest newInstance(AppAddedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
    ...
    public static QueueInfoRequest newInstance(AppRemovedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        request.setApplicationId(event.getApplicationID());
    ...
    public static QueueInfoRequest newInstance(AppAttemptAddedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
    ...
    public static QueueInfoRequest newInstance(AppAttemptRemovedSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        request.setApplicationId(event.getApplicationAttemptID().getApplicationId());
        request.setAttemptId(event.getApplicationAttemptID().getAttemptId());
    ...
    public static QueueInfoRequest newInstance(ContainerExpiredSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
    ...
    public static QueueInfoRequest newInstance(NodeLabelsUpdateSchedulerEvent event) {
        QueueInfoRequest request = newInstance(event.getType());
        //TODO UpdatedNodeToLabels
        return request;
    }

    public static QueueInfoRequest newInstance(SchedulerEvent event) {
        return newInstance(event.getType());
    }

    public static QueueInfoRequest newInstance(SchedulerEventType type) {
        QueueInfoRequest request = Records.newRecord(QueueInfoRequest.class);
