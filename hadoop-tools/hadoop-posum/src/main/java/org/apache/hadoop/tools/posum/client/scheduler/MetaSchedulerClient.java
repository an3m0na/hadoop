package org.apache.hadoop.tools.posum.client.scheduler;
...
public class MetaSchedulerClient extends AbstractService implements MetaScheduler {
  ...
  private SimpleResponse sendSimpleRequest(String kind, SimpleRequest request) {
    try {
      return CommUtils.handleError(kind, metaClient.handleSimpleRequest(request));
