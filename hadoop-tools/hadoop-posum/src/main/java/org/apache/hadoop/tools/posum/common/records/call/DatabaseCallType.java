...
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.DeleteByIdCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.DeleteByQueryCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.FindByIdCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.FindByQueryCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.IdsByQueryCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.JobForAppCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.RawDocumentsByQueryCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.SaveJobFlexFieldsCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.StoreAllCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.StoreCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.StoreLogCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.TransactionCallPBImpl;
import org.apache.hadoop.tools.posum.common.records.call.impl.pb.UpdateOrStoreCallPBImpl;
